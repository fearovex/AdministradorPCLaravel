      ...
      return (
         <div className="add-task p-20">
            ...
            <Modal isOpen={addNewTaskModal} toggle={this.toggleAddNewTaskModal}>
               ...
               <ModalFooter>
                  <Button variant="contained" className="btn-primary text-white" onClick={this.addNewTask}><IntlMessages id="button.add" /></Button>{' '}
                  <Button variant="contained" className="btn-danger text-white" onClick={this.toggleAddNewTaskModal}><IntlMessages id="button.cancel" /></Button>
               </ModalFooter>
            </Modal>
         </div>
      );
