...
export default class DetailEvents extends Component {
	...
	async handleDateFilter(e){
        ...
        try {
			...
			let res = await fetch('http://administradorpclaravel.test:8080/api/detailEvents', config)
	...
	async componentDidMount(){
		...
		try {
			...
			let resNameColumns = await fetch('http://administradorpclaravel.test:8080/api/nameColumnNames', onlyTableConfig)
