            ...
            >
               <div className="row">
                  <RctCollapsibleCard customClasses="text-center p-20" colClasses="col-sm-6 col-lg-4 col-xl-3">
                     ...
                     <Chip
                        className="bg-warning text-white mr-10 mb-10"
                        label="Basic Chip"
                     />
                  </RctCollapsibleCard>
                  <RctCollapsibleCard customClasses="text-center p-20" colClasses="col-sm-6 col-lg-4 col-xl-3">
                     ...
                     <Chip
                        className="bg-success text-white mr-10 mb-10"
                  ...
                  <RctCollapsibleCard customClasses="text-center p-20" colClasses="col-sm-6 col-lg-4 col-xl-3">
                     ...
                     <Chip
                        ...
                        avatar={<Avatar src={require('Assets/img/user-5.jpg')} />}
                  ...
                  <RctCollapsibleCard customClasses="text-center p-20" colClasses="col-sm-6 col-lg-4 col-xl-3">
                     <h5 className="mb-20">Chip With Avatar</h5>
                     <Chip
                        className="bg-danger text-white mr-10 mb-10"
                        avatar={<Avatar src={require('Assets/img/user-5.jpg')} />}
                        label="Deletable Chip" onDelete={handleDelete}
                     />
                  </RctCollapsibleCard>
                  <RctCollapsibleCard customClasses="text-center p-20" colClasses="col-sm-6 col-lg-4 col-xl-3">
