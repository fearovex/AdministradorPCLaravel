      ...
      return (
         <div className="drawer-wrapper">
            ...
            >
               ...
               <Button color="primary" className="text-white mr-10 mb-10" variant="contained" onClick={this.toggleDrawer('right', true)}>Open Right</Button>
               <Button color="primary" className="text-white mr-10 mb-10" variant="contained" onClick={this.toggleDrawer('top', true)}>Open Top</Button>
               <Button color="primary" className="text-white mr-10 mb-10" variant="contained" onClick={this.toggleDrawer('bottom', true)}>Open Bottom</Button>
